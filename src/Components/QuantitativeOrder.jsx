                ...
                <div className="ant-card-body">
                    ...
                    <div data-v-731480cd>
                        ...
                        >
                            ...
                            />
                            <font style={{ verticalAlign: "inherit" }} />
                            <a data-v-731480cd style={{ fontWeight: 600 }}>
                                <font style={{ verticalAlign: "inherit" }}>
                                    <font style={{ verticalAlign: "inherit" }}>0 </font>
                                </font>
                            </a>
                            <font style={{ verticalAlign: "inherit" }}>
                                <a data-v-731480cd style={{ marginLeft: "24px" }}>
                                ...
                                <div className="ant-spin-container">
                                                        ...
                                                        <tbody className="ant-table-tbody">
                                                            ...
                                                            >
                                                                ...
                                                                <td className style={{ textAlign: "center" }}>
                                                                    <font style={{ verticalAlign: "inherit" }}>
                                                                        <font style={{ verticalAlign: "inherit" }}>
                                                                            0xBEEcD07B4D264e3Dd29d272ebb41319Bebeac7b9
                                                                        </font>
                                                                    </font>
                                                                </td>
                                                                <td
                                                            ...
                                                            <tr
                                                                className="ant-table-row ant-table-row-level-0"
                                                                data-row-key={1671311026770468866}
                                                            >
                                                                <td className="ant-table-selection-column">
                                                                    <span>
                                                                        <label className="ant-checkbox-wrapper">
                                                            ...
                                                            <tr
                                                                className="ant-table-row ant-table-row-level-0"
                                                                data-row-key={1670999989621940226}
                                                            >
                                                                <td className="ant-table-selection-column">
                                                                    <span>
                                                                        <label className="ant-checkbox-wrapper">
                                                                ...
                                                                <td className style={{ textAlign: "center" }}>
                                                                    <font style={{ verticalAlign: "inherit" }}>
                                                                        <font style={{ verticalAlign: "inherit" }}>
                                                                            0xfDCAcA2416b7265f68a4Ac3083E201365F4527f4
                                                                        </font>
                                                                    </font>
                                                                </td>
                                                                <td
                                                            ...
                                                            <tr
                                                                className="ant-table-row ant-table-row-level-0"
                                                                data-row-key={1670409953230774274}
                                                            >
                                                                <td className="ant-table-selection-column">
                                                                    <span>
                                                                        <label className="ant-checkbox-wrapper">
                                                                ...
                                                                <td className style={{ textAlign: "center" }}>
                                                                    <font style={{ verticalAlign: "inherit" }}>
                                                                        <font style={{ verticalAlign: "inherit" }}>
                                                                            0x01f70f96b8ac951911c7c202dc04665f555a1253
                                                                        </font>
                                                                    </font>
                                                                </td>
                                                                <td
                                                            ...
                                                            <tr
                                                                className="ant-table-row ant-table-row-level-0"
                                                                data-row-key={1670128854218891266}
                                                            >
                                                                <td className="ant-table-selection-column">
                                                                    <span>
                                                                        <label className="ant-checkbox-wrapper">
                                                                ...
                                                                <td className style={{ textAlign: "center" }}>
                                                                    <font style={{ verticalAlign: "inherit" }}>
                                                                        <font style={{ verticalAlign: "inherit" }}>
                                                                            0x45165B16d48736c488008b16c9B550E508049Bb1
                                                                        </font>
                                                                    </font>
                                                                </td>
                                                                <td
                                                            ...
                                                            <tr
                                                                className="ant-table-row ant-table-row-level-0"
                                                                data-row-key={1670119373154082818}
                                                            >
                                                                <td className="ant-table-selection-column">
                                                                    <span>
                                                                        <label className="ant-checkbox-wrapper">
                                                                ...
                                                                <td className style={{ textAlign: "center" }}>
                                                                    <font style={{ verticalAlign: "inherit" }}>
                                                                        <font style={{ verticalAlign: "inherit" }}>
                                                                            0x7c6e6c58b9f3d69b554d33376be55ab9e1460345
                                                                        </font>
                                                                    </font>
                                                                </td>
                                                                <td
                                                            ...
                                                            <tr
                                                                className="ant-table-row ant-table-row-level-0"
                                                                data-row-key={1669910293097537538}
                                                            >
                                                                <td className="ant-table-selection-column">
                                                                    <span>
                                                                        <label className="ant-checkbox-wrapper">
                                                                ...
                                                                <td className style={{ textAlign: "center" }}>
                                                                    <font style={{ verticalAlign: "inherit" }}>
                                                                        <font style={{ verticalAlign: "inherit" }}>
                                                                            0xA8F1214a53E76aaAAaE297B2868CB8D52829A1Ef
                                                                        </font>
                                                                    </font>
                                                                </td>
                                                                <td
                                                            ...
                                                            <tr
                                                                className="ant-table-row ant-table-row-level-0"
                                                                data-row-key={1669869444804435970}
                                                            >
                                                                <td className="ant-table-selection-column">
                                                                    <span>
                                                                        <label className="ant-checkbox-wrapper">
                                                                ...
                                                                <td className style={{ textAlign: "center" }}>
                                                                    <font style={{ verticalAlign: "inherit" }}>
                                                                        <font style={{ verticalAlign: "inherit" }}>
                                                                            0xc3F52702D3c8a36157A03a8B6A9F9F397D576a08
                                                                        </font>
                                                                    </font>
                                                                </td>
                                                                <td
                                                            ...
                                                            <tr
                                                                className="ant-table-row ant-table-row-level-0"
                                                                data-row-key={1669648238432018434}
                                                            >
                                                                <td className="ant-table-selection-column">
                                                                    <span>
                                                                        <label className="ant-checkbox-wrapper">
                                                                ...
                                                                <td className style={{ textAlign: "center" }}>
                                                                    <font style={{ verticalAlign: "inherit" }}>
                                                                        <font style={{ verticalAlign: "inherit" }}>
                                                                            0x319B7F98f4345dbe8431a57B714Cbcb0CC952D2f
                                                                        </font>
                                                                    </font>
                                                                </td>
                                                                <td
                                                            ...
                                                            <tr
                                                                className="ant-table-row ant-table-row-level-0"
                                                                data-row-key={1669435399486365697}
                                                            >
                                                                <td className="ant-table-selection-column">
                                                                    <span>
                                                                        <label className="ant-checkbox-wrapper">
                                                                ...
                                                                <td className style={{ textAlign: "center" }}>
                                                                    <font style={{ verticalAlign: "inherit" }}>
                                                                        <font style={{ verticalAlign: "inherit" }}>
                                                                            0xab968aa0dfeb8d0f8cfef97a484e97e7f27fe86b
                                                                        </font>
                                                                    </font>
                                                                </td>
                                                                <td
                                    ...
                                    >
                                        ...
                                        <li
                                            title={16}
                                            tabIndex={0}
                                            className="ant-pagination-item ant-pagination-item-16"
                                        >
                                            <a>
                                                <font style={{ verticalAlign: "inherit" }}>
                                                    <font style={{ verticalAlign: "inherit" }}>16</font>
                                                </font>
                                            </a>
                                        </li>
                                        <li
                                        ...
                                        <li className="ant-pagination-options">
                                            ...
                                            >
                                                <div
                                                    ...
                                                    aria-autocomplete="list"
                                                    aria-haspopup="true"
                                                    aria-controls="f4109468-a270-423b-9630-849ccb1ccdb4"
                                                    className="ant-select-selection ant-select-selection--single"
                                                >
                                                    <div className="ant-select-selection__rendered">
                                                        <div
...
export default QuantitativeOrder;
